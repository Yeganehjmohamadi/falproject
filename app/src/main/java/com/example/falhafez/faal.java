...
public class faal extends AppCompatActivity {
        ...
        private void getFaal() {
            ...
            Call<faall> call = falApi.getFal();
            call.enqueue(new Callback<faall>() {
                @Override
                public void onResponse(Call<faall> call, Response<faall> response) {
                    if (response.isSuccessful()) {
                        faall faal = response.body();
                ...
                @Override
                public void onFailure(Call<faall> call, Throwable t) {
